  ...
  return (
    ...
    >
      ...
      <blockquote className="max-w-3xl mx-auto px-8 md:px-12 lg:px-16 text-center">
        <span 
          className="text-3xl md:text-4xl leading-none inline mr-1"
          style={{ 
        ...
        <p 
          className="text-lg md:text-xl lg:text-2xl leading-relaxed italic inline"
          style={{ 
        ...
        <span 
          className="text-3xl md:text-4xl leading-none inline ml-1"
          style={{ 
            color: tokens.colors.primaryLight,
            fontFamily: "'Bodoni Moda', serif" 
          }}
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20">
          <div>
            ...
            >
              Chaque enfant est <em className="italic" style={{ color: tokens.colors.primaryLight }}>unique</em>
            </h2>
          </div>
